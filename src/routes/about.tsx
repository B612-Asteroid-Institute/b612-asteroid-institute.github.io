        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
              <div className="member">
                <div className="member-img">
                  <img src={require("../img/team/AlecKoumjian.jpg")} className="img-fluid" alt="" />
                  <div className="social">
                    <a href="https://www.linkedin.com/in/akoumjian/"><i className="bi bi-linkedin"></i></a>
                  </div>
                </div>
                <div className="member-info">
                  <h4>Alec Koumjian</h4>
                  <span>Head of Software Engineering, Asteroid Institute</span>
                </div>
              </div>
            </div>
